            ...
            LearnSection(
                ...
                topics = listOf(
                    LearnTopic(
                        ...
                        words = listOf(
                            WordData(id = "44", arabic = "بسم", translation = "In the name"),
                            WordData(id = "45", arabic = "الله", translation = "Allah"),
                            WordData(id = "46", arabic = "الرحمن", translation = "The Merciful"),
                            WordData(id = "47", arabic = "الرحيم", translation = "The Compassionate"),
                            WordData(id = "48", arabic = "الحمد", translation = "All praise"),
                            WordData(id = "49", arabic = "لله", translation = "To Allah"),
                            WordData(id = "50", arabic = "رب", translation = "Lord"),
                            WordData(id = "51", arabic = "العالمين", translation = "Of all worlds")
                        ),
                        translations = mapOf("en" to "In the name of Allah, the Merciful, the Compassionate. All praise is to Allah, Lord of all worlds"),
                        referenceSource = "Quran",
                        referenceNumber = "1:1-4",
